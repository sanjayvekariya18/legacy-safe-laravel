...
var Select = /*#__PURE__*/function () {
  ...
  select_createClass(Select, [{
    ...
    key: "CreateAccountSelect",
    value: function CreateAccountSelect() {
      $(".js-select3").select2({
        closeOnSelect: true,
        placeholder: "Select a state",
        allowClear: false,
...
;// CONCATENATED MODULE: ./src/js/parts/singledocument.js
function singledocument_typeof(obj) { "@babel/helpers - typeof"; return singledocument_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, singledocument_typeof(obj); }
function singledocument_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function singledocument_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, singledocument_toPropertyKey(descriptor.key), descriptor); } }
function singledocument_createClass(Constructor, protoProps, staticProps) { if (protoProps) singledocument_defineProperties(Constructor.prototype, protoProps); if (staticProps) singledocument_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function singledocument_toPropertyKey(arg) { var key = singledocument_toPrimitive(arg, "string"); return singledocument_typeof(key) === "symbol" ? key : String(key); }
function singledocument_toPrimitive(input, hint) { if (singledocument_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (singledocument_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var SingleDocument = /*#__PURE__*/function () {
  function SingleDocument() {
    singledocument_classCallCheck(this, SingleDocument);
  }
  singledocument_createClass(SingleDocument, [{
    key: "init",
    value: function init() {
      this.DocData();
      this.Switches();
...
jquery_default()(function () {
  ...
  window.select.init();
  window.singledocument = new SingleDocument();
  window.singledocument.init();
});
