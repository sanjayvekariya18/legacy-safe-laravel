                            ...
                            <div id="accordion-content" class="accordion-content dpt-60 px-4" style="display: none;">
                                <table class="table common-table ready-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="5" class="text-center">No Intvited User Not Found Please New User Invitation Link Created</td>
                                        </tr>
                                        @else

                                        @foreach ($usersPermission as $permission)
                                        <form method="POST" action="{{ route('document.update', $permission->id) }}">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $permission->professional_type }}</td>
                                                <td>
                                                    <div
                                                        ...
                                                        <input type="hidden" name="to_be_notified" value="0">

                                                        <input type="radio" name="to_be_notified" value="1" {{
                                                            $permission->to_be_notified ? 'checked' : '' }} Yes
                                                        class="position-absolute top-0 start-0 h-100 w-50
                                                        cursor-pointer opacity-0 z-5 input">


                                                        <input type="radio" name="to_be_notified" value="0" {{
                                                            !$permission->to_be_notified ? 'checked' : '' }} No
                                                        class="position-absolute top-0 end-0 h-100 w-50
                                                        cursor-pointer opacity-0 z-5 input2">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        <div
                                                            ...
                                                            <input type="hidden" name="to_be_visible" value="0">

                                                            <input type="radio" name="to_be_visible" value="1" {{
                                                                $permission->to_be_visible ? 'checked' : '' }} yes
                                                            class="position-absolute top-0 start-0 h-100 w-50
                                                            cursor-pointer opacity-0 z-5 input">

                                                            <input type="radio" name="to_be_visible" value="0" {{
                                                                !$permission->to_be_visible ? 'checked' : '' }}no
                                                            class="position-absolute top-0 end-0 h-100 w-50
                                                            cursor-pointer opacity-0 z-5 input2">
                                                        ...
                                                        <button type="submit" class="bg-224598 text-white"
                                                            style="padding: 4px 8px; font-size: 12px; border-radius: 3px; line-height: 1; transition: all 0.3s ease;">
                                                            Notify, Visibility Permission
                                                        </button>
                ...
                <table class="table common-table ready-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <img src="{{ asset($documents->url) }}" alt="{{ $documents->name }}"
                                    class="img-thumbnail" style="max-width: 150px; max-height: 150px;"></td>
                        </tr>
                        @else
                        <tr>
