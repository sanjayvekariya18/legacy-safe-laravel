                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    <form method="POST" action="{{ route('invitProfessionalRegister', ['id' => $id]) }}">
                                        ...
                                        <div class="row input-row">
                                            <div class="col-6 position-relative dmb-20">
                                                <x-text-input type="text" name="address1"
                                                    placeholder="First line of address…" :value="old('address1')"
                                                    autocomplete="address1" />
                                                <x-input-error :message="$errors->first('address1')" />
                                            </div>
                                            <div class="col-6 position-relative dmb-20">
                                                <x-text-input type="text" name="address2"
                                                    placeholder="Second line of address…" :value="old('address2')"
                                                    autocomplete="address2" />
                                                <x-input-error :message="$errors->first('address2')" />
                                            </div>
                                            <div class="col-6 position-relative dmb-20">
                                                <x-text-input type="text" name="country" placeholder="Country…"
                                                    :value="old('country')" autocomplete="country" />
                                                <x-input-error :message="$errors->first('country')" />
                                            </div>
                                            <div class="col-6 position-relative dmb-20">
                                                <x-text-input type="text" name="postcode" placeholder="Postcode…"
