                        ...
                        <form action="{{ route('user-manage.update',$user->id)}}" method="POST">
                            ...
                            <div class="col-11 user-permission">
                                <div class="row input-row dpb-30">
                                    ...
                                    <div class="col-6">
                                        <x-text-input type="tel" placeholder="Mobile Number (+44)" name="mobile_number"
                                ...
                                <div class="row input-row dpb-45">
                                    ...
                                    <div class="col-6">
                                        <x-text-input type="text" placeholder="First line of address…" name="address1"
                                            value="{{ old('address1', $user->address1) }}" id="address1"
                                            class="tk-basic-sans fw-normal input white-b-input font16 leading24 space-0_16 w-100 dmb-15"
                                    ...
                                    <div class="col-6">
                                        <x-text-input type="text" placeholder="Second line of address…" name="address2"
                                            value="{{ old('address2', $user->address2) }}" id="address2"
                                            class="tk-basic-sans fw-normal input white-b-input font16 leading24 space-0_16 w-100 dmb-15"
                                    ...
                                    <div class="col-6">
                                        <x-text-input type="text" placeholder="Country…" name="country" id="country"
                                    ...
                                    <div class="col-6">
                                        <x-text-input type="text" placeholder="Postcode…" name="postcode" id="postcode"
                            ...
                            <div>
                                ...
                                <form id="delete-form" id="delete-button"
                                    ...
                                    <button type="submit"
                                        ...
                                        <img src="{{ asset('images/delet.svg') }}" class="permission-box-user-logo me-1"
                                            alt="delete icon">
                                        Remove User
                                    </button>
                                </form>
