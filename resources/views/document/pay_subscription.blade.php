                                ...
                                <div class="upgrade-cards radius5 bg-white dpt-35 dpb-30">
                                    ...
                                    <div>
                                        ...
                                        <div class="row row8 dmb-10">
                                            ...
                                            <div class="col-8">
                                                <input type="text" placeholder="Expiration…" name="expiration" id="expiration"
                                ...
                                <div class="upgrade-cards radius5 bg-white dpt-35 dpb-45">
                                    ...
                                    <div
                                        ...
                                        <img src="{{ asset('images/down-arrow.svg') }}" class="correct-arrow mt-2 me-2"
                                            alt="down-arrow icon">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed</div>
                                    <div
                                        class="tk-basic-sans fw-normal font12 leading22 space-0_12 text-808080 d-flex align-items-start">
                                        <img src="{{ asset('images/down-arrow.svg') }}" class="correct-arrow mt-2 me-2"
                                            alt="down-arrow icon ">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed</div>
