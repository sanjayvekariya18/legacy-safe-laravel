                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a href="#remove-user" data-id="{{ $user->id }}"
                                                            ...
                                                            <img src="{{ asset('images/delet.svg') }}" alt="Delete"
                                                                class="h-100">
                                                        </a>
        ...
        <div
            ...
            <div class="">
                ...
                <div class="d-flex align-items-center row6">
                    <div class="col-6">
                        <form id="delete-form" action="{{ route('user-manage.destroy',':id') }}"
                            method="POST">
        ...
        <div
            ...
            <form action="{{ route('user-manage.store') }}" method="post" id="user-form">
                ...
                <div class="w-100 d-flex justify-content-center">
                    <ul class="nav nav-tabs create-account-tabs bg-EBEBEB border-0 d-inline-flex align-items-center radius5 overflow-hidden px-1 dmb-15"
                        ...
                        <li class="nav-item" role="presentation">
                            <button onclick="setRole(1)" class="nav-link active tk-basic-sans fw-normal font14 leading22 space-0_14 py-1 radius5 px-3 text-black" id="home-tab" data-bs-toggle="tab"
                                data-bs-target="#home" type="button" role="tab1" aria-controls="home"
                                aria-selected="true">
                                I’m a customer
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button onclick="setRole(0)"   class="nav-link tk-basic-sans fw-normal font14 leading22 space-0_14 py-1 radius5 px-3 text-black" id="profile-tab" data-bs-toggle="tab"
                                data-bs-target="#profile" type="button" role="tab2" aria-controls="profile"
                                aria-selected="false">
                                I’m a professional
                            </button>
                        </li>
                ...
                <div class="tab-content" id="myTabContent">
                    <!-- Customer Tab -->
                    <div class="tab-pane fade w-100 show active" id="home" role="tabpanel" aria-labelledby="home-tab">
