            ...
            <div class="position-relative w-100">
                <form action="{{ route('users.index') }}" method="GET" class="d-flex">
                    ...
                    <div class="position-absolute h-100 top-0 end-0 d-flex align-items-center justify-content-end pe-2">
                        <button type="submit" class="bg-224598 search-icon radius4 d-flex align-items-center justify-content-center border-0">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="{{ route('users.edit', ['user' => $user->id]) }}"
                                        class="text-decoration-none border-0 bg-224598 tk-basic-sans font14 leading14 space-0_14 text-white py-2 px-4 radius5 bg-224598-btn">View</a>
